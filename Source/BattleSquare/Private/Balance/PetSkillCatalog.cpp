...
EActionType FPetSkillCatalog::SkillFromName(const FString& SkillName)
{
	...
	if (SkillName.Equals(TEXT("incendiar"), ESearchCase::IgnoreCase))
	{
		return EActionType::Incendiar;
	}

	if (SkillName.Equals(TEXT("eletrificar"), ESearchCase::IgnoreCase))
	{
		return EActionType::Eletrificar;
	}
