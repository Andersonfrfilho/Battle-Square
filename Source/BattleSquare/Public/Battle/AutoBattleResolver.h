...
namespace AutoBattleResolver
{
	 ...
	 *
	 * `Side0Style` é o perfil de quem a I.A. SIMULA no lado 0 (decisão 15-d:
	 * "a I.A. batalha por você baseando nos seus movimentos"): os tipos de
	 * ação saem do histórico dele. Nulo, o lado 0 joga uniforme — o bot de
	...
	BATTLESQUARE_API uint8 ResolveBotVsBot(FBattleState State, uint64 BotSeed,
		const TArray<int32>* Side0Style = nullptr);
}
